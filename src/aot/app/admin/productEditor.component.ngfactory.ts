...
export class View_ProductEditorComponent0 extends import1.AppView<import0.ProductEditorComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._DefaultValueAccessor_38_3 = new import13.Wrapper_DefaultValueAccessor(this.renderer,new import17.ElementRef(this._el_38));
    ...
    this._RouterLink_44_3 = new import15.Wrapper_RouterLink(this.parentView.injectorGet(import9.Router,this.parentIndex),this.parentView.injectorGet(import10.ActivatedRoute,this.parentIndex));
