...
export class View_AdminComponent0 extends import1.AppView<import0.AdminComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_3 = this.renderer.createText(this._el_2,'Placeholder For Admin Features',(null as any));
    this._text_4 = this.renderer.createText(this._el_0,'\n',(null as any));
    this._text_5 = this.renderer.createText(parentRenderNode,'\n\n',(null as any));
    this._el_6 = import3.createRenderElement(this.renderer,parentRenderNode,'div',new import3.InlineArray4(4,'class','m-t-1','style','margin-top: 60px;'),(null as any));
    ...
    this._RouterLink_10_3 = new import10.Wrapper_RouterLink(this.parentView.injectorGet(import9.Router,this.parentIndex),this.parentView.injectorGet(import15.ActivatedRoute,this.parentIndex));
    this._RouterLinkActive_10_4 = new import11.Wrapper_RouterLinkActive(this.parentView.injectorGet(import9.Router,this.parentIndex),new import16.ElementRef(this._el_10),this.renderer,this.ref);
    ...
    this._RouterLink_13_3 = new import10.Wrapper_RouterLink(this.parentView.injectorGet(import9.Router,this.parentIndex),this.parentView.injectorGet(import15.ActivatedRoute,this.parentIndex));
    this._RouterLinkActive_13_4 = new import11.Wrapper_RouterLinkActive(this.parentView.injectorGet(import9.Router,this.parentIndex),new import16.ElementRef(this._el_13),this.renderer,this.ref);
    ...
    this._RouterOutlet_22_5 = new import14.Wrapper_RouterOutlet(this.parentView.injectorGet(import17.RouterOutletMap,this.parentIndex),this._vc_22.vcRef,this.parentView.injectorGet(import18.ComponentFactoryResolver,this.parentIndex),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import19.RouterLink) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._RouterLink_10_3.context; }
    if (((token === import20.RouterLinkActive) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._RouterLinkActive_10_4.context; }
    if (((token === import19.RouterLink) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) { return this._RouterLink_13_3.context; }
    if (((token === import20.RouterLinkActive) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) { return this._RouterLinkActive_13_4.context; }
    if (((token === import21.RouterOutlet) && (22 === requestNodeIndex))) { return this._RouterOutlet_22_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
