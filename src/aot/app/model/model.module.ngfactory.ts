...
class ModelModuleInjector extends import0.NgModuleInjector<import1.ModelModule> {
  ...
  __StaticDataSource_10:import7.RestDataSource;
  __Cart_11:import9.Cart;
  __Order_12:import10.Order;
  __OrderRepository_13:import11.OrderRepository;
  ...
  get _StaticDataSource_10():import7.RestDataSource {
    if ((this.__StaticDataSource_10 == null)) { (this.__StaticDataSource_10 = new import7.RestDataSource(this._Http_7)); }
    return this.__StaticDataSource_10;
  }
  get _Cart_11():import9.Cart {
    if ((this.__Cart_11 == null)) { (this.__Cart_11 = new import9.Cart()); }
    return this.__Cart_11;
  }
  get _Order_12():import10.Order {
    if ((this.__Order_12 == null)) { (this.__Order_12 = new import10.Order(this._Cart_11)); }
    return this.__Order_12;
  }
  get _OrderRepository_13():import11.OrderRepository {
    if ((this.__OrderRepository_13 == null)) { (this.__OrderRepository_13 = new import11.OrderRepository(this._RestDataSource_8)); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import16.StaticDataSource)) { return this._StaticDataSource_10; }
    if ((token === import9.Cart)) { return this._Cart_11; }
    if ((token === import10.Order)) { return this._Order_12; }
    if ((token === import11.OrderRepository)) { return this._OrderRepository_13; }
